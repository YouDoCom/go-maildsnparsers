...
X-Mailer-Daemon-Recipients: leaeyz@example.com
X-Mailer-Daemon-Error: user_not_found
...
a test `
	...
	assert.Len(t, recipients, 1, "Recipients len")
	assert.EqualValues(t, []Result{Result{Address: "leaeyz@example.com", Reason: "user_not_found"}}, recipients)
}
